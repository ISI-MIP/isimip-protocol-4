...
::: show simulation_round=ISIMIP4b
    ...
    In ISIMIP4b, we adopt the CMIP7 convention of distinguishing between concentration-driven runs (e.g., `scen7-h`) and emission-driven runs (e.g., `esm-scen7-h`). Please note that both experiment types are associated with the same ISIMIP experiments, namely the **high emission scenario**. See also Table 2.2.
...
::: show simulation_round=ISIMIP4b
    ...
    Please note that there is no "pre-industrial control run" from 1601-1849 for these experiments (`2021soc`, `nat`, `fire`, `nondep`, `nondep2021co2`) and hence the spin-up links directly to the historical period.
