...
::: show sector=forestry
    ...
    #### Tree species and disturbance types

    ::: table identifier=species caption="Table 4.5: Tree species and disturbance types (`species`)."
...
::: show sector=lakes_local
    ...
    A document with additional information is maintained by the sector coordinators and provided at <https://docs.google.com/spreadsheets/d/1IvroBMuOI75qco1eNc3lec-TtkjK33BM1NUzRy6D5ew>.

::: show sector=water_regional

    #### Catchment gauging stations

    ::: table identifier=station caption="Table 4.9: Catchment gauging stations for reporting regional hydrological model results (`station`)."
...
::: show sector=water_quality
    ...
    Additional agricultural-related model inputs such as N biological fixation, crop uptake, grassland uptake, animal manure use in cropland and on grassland and livestock numbers are not available for ISIMIP4b Groups I+II. These additional forcings will be available to simulate ISIMIP4b (Group III). The same holds for additional human-related model inputs for point sources such as sewage connections of urban/rural population, treatment removal fractions, anthropogenic point source inputs to surface waters (total effluents), wastewater production, collection, treatment and reuse.
