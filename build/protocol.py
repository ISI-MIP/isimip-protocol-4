...
def show_generator(ctx, simulation_round=None, sector=None):
    return E(
        'div',
        {'data-component': 'show', 'data-simulation-round': simulation_round, 'data-sector': sector},
        Markdown(ctx.content, ctx.parser),
    )
...
def hide_generator(ctx, simulation_round=None, sector=None):
    return E(
        'div',
        {'data-component': 'hide', 'data-simulation-round': simulation_round, 'data-sector': sector},
        Markdown(ctx.content, ctx.parser),
    )
...
def table_generator(ctx, identifier, caption):
    return E(
        'div',
        {'data-component': 'table', 'data-identifier': identifier, 'data-caption': caption},
        Markdown(ctx.content, ctx.parser),
    )
